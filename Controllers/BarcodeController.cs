...
namespace AMS.Controllers
{
    ...
    public class BarcodeController : Controller
    {
        ...
        public BarcodeController(ApplicationDbContext context, ICommon iCommon)
        {
            _context = context;
            _iCommon = iCommon;
        }
        ...
        public IActionResult GetDataTabelData()
        {
            try
            {
                ...
                var _GetGridItem = _iCommon.GetBarcodeList().AsQueryable();
                //Sorting
                ...
                if (!string.IsNullOrEmpty(searchValue))
                {
                    ...
                    || obj.AssignUserName.ToLower().Contains(searchValue));
                }
