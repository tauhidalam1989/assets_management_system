...
var Loadddl = function () {
    var _url = "/AssetCategorie/GetAllAssetCategorie";
    GetDropDownDataBase("CategoryId", _url);
    $("#CategoryId").select2();

    var _url = "/AssetSubCategorie/GetAllAssetSubCategorie";
    GetDropDownDataBase("SubCategoryId", _url);
...
var GetAssetInfoReportData = function (_CategoryId, _SubCategoryId,print) {
    $("#tblAssetInfoReport").DataTable({
                ...
                buttons: [
                    {
                        ...
                        exportOptions: {
                            columns: [0, 2, 3, 4, 5, 6], //column id visible in PDF
                            modifier: {
                                // DataTables core
        ...
        "ajax": {
            "url": "/AssetInfoReport/GetDataTabelData?CategoryId=" + _CategoryId + "&SubCategoryId=" + _SubCategoryId,
            "type": "POST",
            "datatype": "json"
        },
